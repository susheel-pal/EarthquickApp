...
/**
 * an {@link EarthquakeAdapter} knows how to create a list of item layout for each earthquake
...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
     ...
     * @param Earthquakes is the list of the earthquake, which is the data source of th adapter
     */
    public EarthquakeAdapter(@NonNull Context context, @NonNull ArrayList<com.example.quickreport.Earthquake> Earthquakes) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //returns the list item view that now showing the list of data
        return listItemView;
    }
